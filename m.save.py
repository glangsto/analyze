...
# raw counts
#plt.plot(xv, hv, colors[0], linestyle=linestyles[0],label="Hot", lw=2)
#plt.plot(xv, cv, colors[1], linestyle=linestyles[0],label="Cold", lw=2)
# normalzied counts
#plt.plot(xv, hvnorm, colors[0], linestyle=linestyles[0],label="Hot", lw=2)
#plt.plot(xv, cvnorm, colors[1], linestyle=linestyles[0],label="Cold", lw=2)
#plt.plot(iv, hvnorm, colors[0], linestyle=linestyles[0],label="Hot", lw=2)
#plt.plot(iv, cvnorm, colors[1], linestyle=linestyles[0],label="Cold", lw=2)
#plt.plot(xv, gain, colors[1], linestyle=linestyles[0],label="gain")
#plt.xlim(1418.4, 1422.4)
deltanorm = cvnorm - hvnorm
deltanorm = deltanorm + 1.0
zeronorm = 0.0*deltanorm + 1.0
#plt.plot(xv, deltanorm, colors[2], linestyle=linestyles[0],label="Cold-Hot", lw=2)
#plt.plot(xv, zeronorm, colors[2], linestyle='--',label="Zero")
#plt.plot(iv, deltanorm, colors[2], linestyle=linestyles[0],label="Cold-Hot", lw=2)
#plt.plot(iv, zeronorm, colors[2], linestyle='--',label="Zero")
#plt.ylim(.950, 1.2)
#plt.xlabel('Frequency (MHz)', fontsize=16)
#plt.ylabel('Intensity (Raw Counts)', fontsize=16)
#plt.title('Comparision of Hot-load and Cold-load normalized Spectra', fontsize=16)
...
if yallmax < 8:
    yallmax = 8
plt.ylim((yallmin*.97)-3., 1.15*yallmax)
#plt.ylim(-2., 8.)
